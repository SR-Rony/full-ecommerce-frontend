...
import { FaMinus, FaPlus, FaShippingFast, FaCreditCard, FaBox, FaExclamationTriangle, FaBitcoin, FaBell, FaInfoCircle, FaFlask, FaLock, FaVial, FaHeartbeat } from 'react-icons/fa';
  ...
  const components = [
      ...
      component: (<div className={`shiping-info ${styles.accordion_items}`}>
          ...
          >
            <div className="flex items-center gap-3 flex-1">
              <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-emerald-400 to-cyan-400 rounded-lg flex items-center justify-center flex-shrink-0">
                <FaShippingFast className='w-4 h-4 md:w-5 md:h-5 text-white' />
              </div>
            ...
            {isActive1 ? (
              <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-emerald-400 flex-shrink-0' />
            ) : (
              <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-emerald-400 flex-shrink-0' />
            )}
          </div>
          {isActive1 && (
            <div>
...

    {
      ...
      component: (<div className={`labtest-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-purple-400 to-pink-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaCreditCard className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
          ...
          {isActive2 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-purple-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-purple-400 flex-shrink-0' />
          )}
        </div>
        {isActive2 && (
          <div className={styles.description_text}>
            <div className={styles.desc_text_cant_wrap+" "+styles.description}>
                ...
                <br />
                After payment is successfully confirmed, orders will take up to 72 hours to be packed (business days M-F) and can take an additional 48 hours (on business days M-F), at absolute busiest times, to be shipped. Usually orders are packed and shipped within 48 hours from the time the order payment is initially confirmed.</p>
            </div>
          </div>
        )}
      </div>)
...

    {
      ...
      component: (<div className={`payment-method-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaBox className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
            <div className={styles.accordion_title_text}>
              PACKAGING INFO
            </div>
          ...
          {isActive3 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-yellow-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-yellow-400 flex-shrink-0' />
          )}
        </div>
        {isActive3 && (
          <div className={styles.description_text}>
...

    {
      ...
      component: (<div className={`order-issue-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-red-400 to-pink-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaExclamationTriangle className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
            <div className={styles.accordion_title_text}>
              ORDER DISCREPANCIES
            </div>
          ...
          {isActive4 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-red-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-red-400 flex-shrink-0' />
          )}
        </div>
        {isActive4 && (
          <div className={styles.description_text}>
...

    {
      ...
      component: (<div className={`tracking-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaBitcoin className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
            <div className={styles.accordion_title_text}>
              PAYMENT METHODS
            </div>
          ...
          {isActive5 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-orange-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-orange-400 flex-shrink-0' />
          )}
        </div>
        {isActive5 && (
          <div className={styles.description_text}>
...

    {
      ...
      component: (<div className={`crypto-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          {isActive6 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-blue-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-blue-400 flex-shrink-0' />
          )}
        </div>
        {isActive6 && (
          <div className={styles.description_text}>
...

    {
      ...
      component: (<div className={`privacy-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaInfoCircle className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
            <div className={styles.accordion_title_text}>WHO WE ARE</div>
          </div>
          {isActive7 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-indigo-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-indigo-400 flex-shrink-0' />
          )}
        </div>
        {isActive7 && (
          <div className={styles.description_text}>
      ...
      component: (<div className={`about-us-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1" onClick={()=>{
            ...
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-teal-400 to-emerald-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaFlask className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
            <div className={styles.accordion_title_text}>ANONYMOUS LAB TESTING RESULTS</div>
          </div>
          {isActive8 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-teal-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-teal-400 flex-shrink-0' />
          )}
        </div>
        {/* {isActive8 && (
          <div className={styles.description_text}>
...

    {
      ...
      component: (      <div className={`privacy-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-amber-400 to-orange-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaBitcoin className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
            <div className={styles.accordion_title_text}>CRYPTO HELP</div>
          </div>
          {isActive9 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-amber-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-amber-400 flex-shrink-0' />
          )}
        </div>
        {isActive9 && (
          <div className={styles.description_text}>
...

    {
      ...
      component: (<div className={`privacy-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-green-400 to-teal-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaLock className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
            <div className={styles.accordion_title_text}>PRIVACY AND SECURITY</div>
          </div>
          {isActive10 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-green-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-green-400 flex-shrink-0' />
          )}
        </div>
        {isActive10 && (
          <div className={styles.description_text}>
...

    {
      ...
      component: (<div className={`privacy-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-pink-400 to-rose-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaVial className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
            <div className={styles.accordion_title_text}>WANT TO GET YOUR PRODUCTS LAB TESTED? READ THIS FIRST.</div>
          </div>
          {isActive11 ? (
            <FaMinus className='w-5 h-5 md:w-6 md:h-6 text-pink-400 flex-shrink-0' />
          ) : (
            <FaPlus className='w-5 h-5 md:w-6 md:h-6 text-pink-400 flex-shrink-0' />
          )}
        </div>
        {isActive11 && (
          <div className={styles.description_text}>
            <div className={styles.desc_text_cant_wrap + " " + styles.description}>
              ...
              <ol className='list-decimal list-inside ms-4 space-y-4'>
                <li>01. All product samples must be tested at Analiza Labs, located in Poland, EU. Please visit their website at <a className='text-blue-500 underline' href="https://analizabialek.com" target='_blank'>https://analizabialek.com</a> for further details. For direct communication, contact them at kontakt@analizabialek.com. Email them for formal instructions, as they only accept payment once the samples are received.</li>
                <li>02. When sending samples, please declare them as "cosmetic samples" with a value between $1-$10. This ensures smooth customs clearance.</li>
                <li>03. We will compare the results from Analiza Labs with those from Janoshik Labs to ensure accurate, reliable, and consistent findings.</li>
                <li>04. The product must be new, sealed, and unopened. When sending a sample, you must also submit photographs taken before sending to the testing facility showing that the APG logo cap, APG HGH box seal, or APG tab packet seal is intact, confirming the package has not been tampered with. Ask the testing facility to include multiple images of the product they receive as well. </li>
                <li>05. We will fully reimburse the cost of the product, testing, and shipping. Any related expenses will be refunded, along with additional compensation for any burdens incurred.</li>
                <li>06. Before shipping, customers must provide the serial number and detailed pre-test photographs of the product. These photos must be taken by the testing facility and attached to the lab report to verify that no tampering has occurred.</li>
              </ol>
              <br/>
...

    {
      ...
      component: (<div className={`privacy-info ${styles.accordion_items}`}>
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-red-400 to-pink-400 rounded-lg flex items-center justify-center flex-shrink-0">
              <FaHeartbeat className='w-4 h-4 md:w-5 md:h-5 text-white' />
            </div>
