...
const ResetPasswordVerify = () => {
  ...
  const [isForgotPasswordOtp, setIsForgotPasswordOtp] = useState(true)
  useMemo(()=>{
    if(typeof document !=='undefined'){
      document.title = 'Reset Password | Hammer and Bell'
    }
  },[])
  useEffect(() => {
    let timer
        ...
        <div className='hidden lg:flex flex-col justify-center space-y-8 text-white'>
          <div>
            ...
            <p className='text-xl text-gray-300 leading-relaxed'>
              Reset your password securely with email verification. Enter your new password and verification code to regain access to your account.
            </p>
          </div>
          <div className='space-y-4'>
            <div className='flex items-center space-x-3'>
              <div className='w-2 h-2 bg-emerald-400 rounded-full'></div>
              <span className='text-gray-300'>Secure Reset</span>
            </div>
            <div className='flex items-center space-x-3'>
            ...
            <div className='flex items-center space-x-3'>
              ...
              <span className='text-gray-300'>Quick Recovery</span>
            </div>
          </div>
        </div>
        ...
        <div className='w-full max-w-md mx-auto lg:mx-0'>
          <div className='bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20'>
            <div className='text-center mb-8'>
              ...
              <p className='text-gray-300'>Enter your credentials to reset password</p>
            </div>
