...
console.log(myfont)
    return (
        <>
            <div className={`shiping-info ${styles.accordion_items} ${myfont.className}`}>
                ...
                >
                    ...
                    {isActive1 ? (<img src="/plus-icons.svg" alt="open icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    ) : (
                        <img src="/minus-icons.svg" alt="close icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    )}
                </div>
                {isActive1 && (
                    <div>
      ...
      <div className={`labtest-info ${styles.accordion_items}`}>
        ...
        >
          ...
          {isActive2 ? (<img src="/plus-icons.svg" alt="open icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    ) : (
                        <img src="/minus-icons.svg" alt="close icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    )}
        </div>
      ...
      <div className={`payment-method-info ${styles.accordion_items}`}>
        ...
        >
          ...
          {isActive3 ? (<img src="/plus-icons.svg" alt="open icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    ) : (
                        <img src="/minus-icons.svg" alt="close icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    )}
        </div>
      ...
      <div className={`order-issue-info ${styles.accordion_items}`}>
        ...
        >
          ...
          {isActive5 ? (<img src="/plus-icons.svg" alt="open icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    ) : (
                        <img src="/minus-icons.svg" alt="close icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    )}
        </div>
      ...
      <div className={`tracking-info ${styles.accordion_items}`}>
        ...
        >
          ...
          {isActive6 ? (<img src="/plus-icons.svg" alt="open icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    ) : (
                        <img src="/minus-icons.svg" alt="close icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    )}
        </div>
      ...
      <div className={`crypto-info ${styles.accordion_items}`}>
        ...
        >
          ...
          {isActive4 ? (<img src="/plus-icons.svg" alt="open icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    ) : (
                        <img src="/minus-icons.svg" alt="close icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    )}
        </div>
      ...
      <div className={`privacy-info ${styles.accordion_items}`}>
        ...
        >
          ...
          {isActive8 ?(<img src="/plus-icons.svg" alt="open icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    ) : (
                        <img src="/minus-icons.svg" alt="close icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    )}
        </div>
      ...
      <div className={`about-us-info ${styles.accordion_items}`}>
        ...
        >
          ...
          {isActive9 ? (<img src="/plus-icons.svg" alt="open icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    ) : (
                        <img src="/minus-icons.svg" alt="close icon" loading="lazy" width="33" height="33" decoding="async" data-nimg="1" />
                    )}
        </div>
